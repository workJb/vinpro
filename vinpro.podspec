...
Pod::Spec.new do |spec|
  ...
  spec.name         = "vinpro"
  spec.version      = "1.0.0"
  spec.summary      = "scan vin for project vinpro."
  ...
  spec.homepage     = "https://github.com/workJb/vinpro"
  ...
  # Or just: spec.author    = "fengjinbiao"
  # spec.authors            = { "fengjinbiao" => "" }
  # spec.social_media_url   = "https://twitter.com/fengjinbiao"
  ...
  spec.source       = { :git => "https://github.com/workJb/vinpro.git", :tag => "#{spec.version}" }
  # spec.source_files  = "vinpro/*.{h,m}"
  ...
  spec.source_files  = "vinpro/Frameworks/MLKitTextRecognitionChinese.framework/Headers/*.{h,m}"
